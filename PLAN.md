...
* This research plan, the formal theory document, and all repository prose are licensed under [CC BY-NC-ND 4.0](https://creativecommons.org/licenses/by-nc-nd/4.0/); code, when added, will carry its own software license in its own directory.
